...
namespace AKOMOPLUGIN\Inc\Post_Types;

use AKOMOPLUGIN\Inc\Abstracts\Post_Type;
...
class Testimonials extends Post_Type {
	...
	public static function init() {
		...
		self::instance()->singular  = esc_html__( 'Testimonial', 'wpakomo' );
		self::instance()->plural    = esc_html__( 'Testimonials', 'wpakomo' );
