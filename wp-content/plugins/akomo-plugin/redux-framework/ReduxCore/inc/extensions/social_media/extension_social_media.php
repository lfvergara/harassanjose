...
if ( !class_exists( 'ReduxFramework_extension_social_media' ) ) {
	...
	class ReduxFramework_extension_social_media extends ReduxFramework {
		...
		public function __construct( $parent ) {
			$this->folder_path =  AKOMOPLUGIN_PLUGIN_PATH.'redux-framework/';
			$this->parent = $parent;
		...
		public function overload_field_path( $field ) {
			...
			return AKOMOPLUGIN_PLUGIN_PATH.'redux-framework/ReduxCore/inc/extensions/' . $this->field_name . '/' . $this->field_name . '.php';
