 ...
 * @since 1.0.0
 */
class Our_Packages_V1 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Packages V1', 'akomo' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_packages_v1',
			[
				'label' => esc_html__( 'Our Packages V1', 'akomo' ),
			]
		);
		$this->add_control(
			'subtitle',
	...
	protected function render() {
        ...
        <!-- Packages Section -->
        <section class="packages-section-two">
                    ...
                    <div class="package-block-two">
                        <div class="inner-box">
                            ...
                            <div class="overlay-cotnent">
                                ...
                                <div class="pack-info">
                                    <span class="adult">Adult : 4 Person</span>
