 ...
 * @since 1.0.0
 */
class Our_Packages_V2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Packages V2', 'akomo' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_packages_v2',
			[
				'label' => esc_html__( 'Our Packages V2', 'akomo' ),
			]
		);
		$this->add_control(
			'subtitle',
	...
	protected function render() {
        ...
        <!-- Packages Section -->
        <section class="packages-section-three">
            <div class="auto-container">
                ...
                <div class="carousel-outer">
                    <div class="packages-carousel-three owl-carousel owl-theme">
                        <?php 
							while ( $query->have_posts() ) : $query->the_post(); 
						?>
                        <!-- Package Block -->
                        <div class="package-block-three">
                            <div class="inner-box">
