...
class Blog_Grid_View extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Blog Grid View', 'akomo' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'blog_grid_view',
			[
				'label' => esc_html__( 'Blog Grid View', 'akomo' ),
			]
		);
		$this->add_control(
			'title',
        ...
        <section class="news-section">
            <div class="auto-container">
                ...
                <div class="row">
					...
					?>
                    <!-- News Block -->
                    <div class="news-block updated col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box">
                            <?php if(has_post_thumbnail()){ ?>
                            <div class="image-box">
                                <figure class="image">
                                	<a href="<?php echo esc_url( the_permalink( get_the_id() ) );?>"><?php the_post_thumbnail('akomo_370x300'); ?></a>
                            ...
                            <div class="lower-content">
                                <div class="post-info">
                                    <div class="post-author ako-meta"><span class="icon flaticon-user-1"></span><?php the_author(); ?></div>
                                    <div class="post-date ako-meta"><span class="icon flaticon-consulting-message"></span> <?php comments_number( wp_kses(__('0 Comments' , 'akomo'), true), wp_kses(__('1 Comment' , 'akomo'), true), wp_kses(__('% Comments' , 'akomo'), true)); ?></div>
                                </div>
                                ...
                                <a href="<?php echo esc_url( the_permalink( get_the_id() ) );?>" class="theme-btn btn-style-two m-t25"><?php esc_html_e('Read More', 'akomo'); ?></a>
                            </div>
                        </div>
                    </div>
                    <?php endwhile; ?>
