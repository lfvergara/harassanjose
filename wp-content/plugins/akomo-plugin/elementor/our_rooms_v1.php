 ...
 * @since 1.0.0
 */
class Our_Rooms_V1 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Rooms V1', 'akomo' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_rooms_v1',
			[
				'label' => esc_html__( 'Our Rooms V1', 'akomo' ),
			]
		);
		$this->add_control(
			'subtitle',
        ...
        <section class="rooms-section-two">
            <div class="auto-container">
                ...
                <div class="sec-title text-center">
                     <?php if($settings['subtitle']) { ?><span class="float-text"><?php echo wp_kses( $settings['subtitle'], true );?></span><?php } ?>
                     <?php if($settings['title']) { ?><h2><?php echo wp_kses( $settings['title'], true );?></h2><?php } ?>
                </div>
    			<?php } ?>
    
                <div class="rooms-carousel owl-carousel owl-theme default-dots">
                    <?php 
                    ...
                    <div class="room-block-two">
                        <div class="inner-box">
                            ...
                            <div class="overlay-cotnent">
                                ...
                                <a href="<?php echo esc_url(get_permalink(get_the_id()));?>" class="link"><?php esc_html_e('Get It Now+', 'akomo' ); ?></a>
                            </div>
                        </div>
                    </div>
    				<?php endwhile;?>
