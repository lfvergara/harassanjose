...
class Testimonials_V1 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Testimonials V1', 'akomo' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'testimonials_v1',
			[
				'label' => esc_html__( 'Testimonials V1', 'akomo' ),
			]
		);
		$this->add_control(
			'bg_title',
        ...
        <section class="testimonial-section-two pt-0">
            <div class="auto-container">
                ...
                <div class="sec-title text-center">
                    <?php if($settings['bg_title']): ?><span class="float-text"><?php echo wp_kses( $settings['bg_title'], $allowed_tags );?></span><?php endif; ?>
                        ...
                        <div class="testimonial-block-two">
                            <div class="inner-box">
                                <div class="image-column">
                                    <figure class="image"><?php the_post_thumbnail('akomo_250x350'); ?></figure>
                                </div>
