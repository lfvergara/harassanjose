...
class Testimonials_V3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Testimonials V3', 'akomo' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'testimonials_v3',
			[
				'label' => esc_html__( 'Testimonials V3', 'akomo' ),
			]
		);
		$this->add_control(
			'subtitle',
                ...
                <div class="carousel-outer">
                                ...
                                <div class="testimonial-block-four">
                                    <div class="inner-box">
                                        <div class="image-column">
                                            <figure class="image"><?php the_post_thumbnail('akomo_500x500'); ?></figure>
                                        </div>
                    ...
                    <div class="swiper-container thumbs-carousel">
                        <div class="swiper-wrapper">
                            <?php while ( $query->have_posts() ) : $query->the_post(); ?>
                            <div class="swiper-slide">
                                <figure class="thumb"><?php the_post_thumbnail('akomo_100x100'); ?></figure>
                            </div>
                            <?php endwhile; ?>
                        </div>
                    </div>
