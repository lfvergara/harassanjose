...
class About_Us_V3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'About Us V3', 'akomo' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'about_us_v3',
			[
				'label' => esc_html__( 'About Us V3', 'akomo' ),
			]
		);
		$this->add_control(
			'about_img',
			[
			  'label' => __( 'About Image', 'akomo' ),
            ...
            <div class="auto-container">
                <div class="row">
                    ...
                    <div class="images-column col-lg-6 col-md-12 col-sm-12">
                    	<figure class="image"><img src="<?php echo esc_url(wp_get_attachment_url($settings['about_img']['id']));?>" alt="<?php esc_attr_e('Awesome Image', 'akomo'); ?>"></figure>
                    </div>
					<?php } ?>
                </div>
            </div>
