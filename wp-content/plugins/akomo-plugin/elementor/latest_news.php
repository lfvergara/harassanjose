...
class Latest_News extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Latest News', 'akomo' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'latest_news',
			[
				'label' => esc_html__( 'Latest News', 'akomo' ),
			]
		);
		$this->add_control(
			'bg_title',
            ...
            <div class="auto-container">
                ...
                <div class="row">
                    ...
                    <div class="news-block-two col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box" style="background-image: url(<?php echo esc_url($post_thumbnail_url);?>);">
