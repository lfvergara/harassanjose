...
class Testimonials_V2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Testimonials V2', 'akomo' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'testimonials_v2',
			[
				'label' => esc_html__( 'Testimonials V2', 'akomo' ),
			]
		);
		$this->add_control(
			'subtitle',
                        ...
                        <div class="testimonial-block-three">
                            <div class="inner-box">
                                <div class="image-column">
                                    <figure class="image"><?php the_post_thumbnail('akomo_450x559'); ?></figure>
                                </div>
