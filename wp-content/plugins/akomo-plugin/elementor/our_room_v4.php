 ...
 * @since 1.0.0
 */
class Our_Room_V4 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Room V4', 'akomo' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_room_v4',
			[
				'label' => esc_html__( 'Our Room V4', 'akomo' ),
			]
		);
		$this->add_control(
			'subtitle',
                        ...
                        <div class="inner-box">
                            ...
                            <div class="overlay-cotnent">
                                ...
                                <div class="text">
                                	...
                                	<a href="<?php echo esc_url(get_permalink(get_the_id()));?>" class="theme-btn btn-style-two m-t15"><?php esc_html_e('Book Now', 'akomo'); ?></a>
                                </div>
