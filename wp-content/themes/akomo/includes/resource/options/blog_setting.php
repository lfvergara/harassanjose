...
return array(
	'title'  => esc_html__( 'Blog Page Settings', 'akomo' ),
	'id'     => 'blog_setting',
	'desc'   => '',
	...
	'fields' => array(
		array(
			'id'      => 'blog_source_type',
			'type'    => 'button_set',
			'title'   => esc_html__( 'Blog Source Type', 'akomo' ),
			'options' => array(
		...
		array(
			'id'       => 'blog_default_st',
			'type'     => 'section',
			'title'    => esc_html__( 'Blog Default', 'akomo' ),
			'indent'   => true,
		...
		array(
			...
			'type'    => 'switch',
			'title'   => esc_html__( 'Show Post Comments', 'akomo' ),
			'desc'    => esc_html__( 'Enable to show post comments on posts listing', 'akomo' ),
			'default' => true,
		),
		...
		array(
			...
			'desc'    => esc_html__( 'Enable to show author on posts listing', 'akomo' ),
			'default' => true,
		),
		array(
			'id'      => 'blog_post_date',
			'type'    => 'switch',
			'title'   => esc_html__( 'Show Post Date', 'akomo' ),
			'desc'    => esc_html__( 'Enable to show post data on posts listing', 'akomo' ),
			'default' => true,
		),
		array(
			'id'       => 'blog_default_ed',
