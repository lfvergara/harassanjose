 ...
 */
//akomo_load_default_hooks
function akomo_load_default_hooks() {

	$config = akomo_WSH()->config( 'default' );
...
/**
 * [akomo_main_header_area description]
 *
 * @return [type] [description]
 */

//akomo_main_header_area
function akomo_main_header_area() {
	...
	//need to change
	if ( $header == 'header_v1' ) {
		akomo_template_load( 'templates/header/default-header.php' );
	} elseif ( $header == 'header_v2' ) {
		akomo_template_load( 'templates/header/header_v2.php' );
	} elseif ( $header == 'header_v3' ) {
		akomo_template_load( 'templates/header/header_v3.php' );
	} elseif ( $header == 'header_v4' ) {
		akomo_template_load( 'templates/header/header_v4.php' );
	} else {
		akomo_template_load( 'templates/header/header_v1.php' );
	}
}

/**
 * [akomo_main_footer_area description]
 *
 * @return [type] [description]
 */
//akomo_main_footer_area
function akomo_main_footer_area() {
	...
	//need to change
	if ( $footer == 'footer_v1' ) {
		akomo_template_load( 'templates/footer/default-footer.php' );
	} elseif ( $footer == 'footer_v2' ) {
		akomo_template_load( 'templates/footer/footer_v2.php' );
	} else {
		akomo_template_load( 'templates/footer/default-footer.php' );
	}
}
...
/**
 * [akomo_sidebar description]
 *
 * @return [type] [description]
 */
//akomo_sidebar
function akomo_sidebar( $data ) {

	akomo_template_load( 'templates/sidebar.php', compact( 'data' ) );
}

/**
 * [akomo_banner description]
 *
 * @return [type] [description]
 */
//akomo_banner
function akomo_banner( $data ) {

	akomo_template_load( 'templates/banner/banner.php', compact( 'data' ) );
