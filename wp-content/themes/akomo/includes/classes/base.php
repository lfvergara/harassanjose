...
use AKOMO\Includes\Classes\Header_Enqueue;
use AKOMO\Includes\Classes\Options;
...
class Base {
	...
	public static function instance() {
		...
		if ( isset( $GLOBALS['akomo_base'] ) ) {
			return $GLOBALS['akomo_base'];
		}
	...
	function option( $key = '' ) {
		...
		$options = (array) get_theme_mod( 'akomo' . '_options-mods' );

		$dn = akomo_dot( $options );
