...
$gallery = get_post_meta( $page_id, 'akomo_gallery_images', true );

$video = get_post_meta( $page_id, 'akomo_video_url', true );


$audio_type = get_post_meta( $page_id, 'akomo_audio_type', true );
...
<div class="blog-detail-page">
    <?php if ( has_post_thumbnail() ) : ?>
    	<figure>
    		<?php akomo_template_load( 'templates/blog-single/image.php', compact( 'options', 'data' ) ); ?>
    	</figure>
    <?php endif; ?>
	<div class="blog-detail-meta">
		<div class="comments-area">
			...
			<?php if ( $options->get( 'single_post_author', true ) ) : ?>
				...
				<span><i class="fas fa-user"></i><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>"><?php esc_html_e( 'By ', 'akomo' );
	...
	<?php if ( $options->get( 'single_post_tag' ) || $options->get( 'single_social_share' ) && $options->get( 'single_post_share' ) ) : ?>
		<div class="detail-btm-meta">
			...
			<?php if ( $options->get( 'single_post_tag' ) ) : ?>
				<?php $title = '<span>' . esc_html__( 'Tags:', 'akomo' ) . '</span>'; ?>
	...
	<?php if ( $options->get( 'single_post_author_box' ) ) : ?>
		...
		<?php akomo_template_load( 'templates/blog-single/author_box.php', compact( 'options', 'data' ) ); ?>
	<?php endif; ?>
